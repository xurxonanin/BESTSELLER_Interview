...
# Indicates the folder where the data is in and where to store the models once they are trained
...
# Quick check of data integrity and  indicate parameters for the data transformation in the pipeline
...
# Preproccess the data using the Transformer on the other file for the date and the Standard score for the rest of the features
...
# Train the model and store it on disk
